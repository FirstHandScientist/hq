...
if __name__ == "__main__":    
    ...
    datatype, splitname, feat_mode = parse("{}-split{}-feat{}", args.opt)
    infile = os.path.join(exp_folder,
                                 "split{}".format(splitname),
                                 "{}".format(data_folder),
    ...
    if totclasses != 39 and totclasses != 61:
        print("(error)", "number of classes must be 61 or 39", file=sys.stderr)
        sys.exit(1)
